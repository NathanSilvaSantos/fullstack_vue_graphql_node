      ...
      <div class="container">
        <div class="row">
          <div class="col-md">
            ...
            <div class="card">
              <div class="card-body">
                <ul class="list-group" v-for="prefix in prefixes" v-bind:key="prefix">
          ...
          <div class="col-md">
            ...
            <div class="card">
              <div class="card-body">
                <ul class="list-group" v-for="sufix in sufixes" v-bind:key="sufix">
                  <li class="list-group-item">
                    <div class="row">
                      <div class="col-md">
                        {{ sufix }}
                ...
                <br>
                <div class="input-group">
                  <input type="text" class="form-control" v-model="sufix" v-on:keyup.enter="addSufix(sufix)" placeholder="Digite o prefixo">
                  <div class="input-group-append">
